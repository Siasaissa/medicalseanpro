											...
											<div class="account-payment-info">
												<div class="row">
													<div class="col-lg-6 col-md-6">
														<div class="payment-amount">
															...
															<span>Tsh <?php echo e(number_format($totalSuccessful ?? 0, 2)); ?></span>
														</div>
													</div>
													<div class="col-lg-6 col-md-6">
														<div class="payment-amount">
															<h6><i class="isax isax-document5 text-success"></i>Total Transaction</h6>
															<span><?php echo e(number_format($totalTransactions ?? 0)); ?></span>
														</div>
													</div>
												</div>
												<div class="payment-request">
													<span>
                                                        ...
                                                        <?php echo e($lastPaymentDate ? \Carbon\Carbon::parse($lastPaymentDate)->format('d M Y h:i A') : 'No payment yet'); ?>
										...
										<div class="custom-new-table">
											<div class="table-responsive">
												<table class="table table-center mb-0">
													...
													<tbody>
														<?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<tr>
															<td>
																<a href="javascript:void(0);" class="link-primary">#AC000<?php echo e($loop->iteration); ?></a>
															</td>
															<td class="text-gray-9"><?php echo e($transact->phone); ?></td>
															<td><?php echo e(ucfirst($transact->appointment_type)); ?></td>
															<td><?php echo e(\Carbon\Carbon::parse($transact->appointment_datetime)->format('d M Y h:i A')); ?></td>
														<td><?php echo e(number_format($transact->total,2)); ?></td>
														<?php if( strtoupper((string)$transact->status) === 'SUCCESS' || strtoupper((string)$transact->status) === 'PAID' ): ?>
															<td>
                                                            ...
                                                            <?php elseif( strtoupper((string)$transact->status) === 'PROCESSING' || strtoupper((string)$transact->status) === 'PENDING' ): ?>
                                                            <td>
...
<?php /**PATH /Users/dope/Downloads/public_htm/resources/views/patient/wallet.blade.php ENDPATH**/ ?>