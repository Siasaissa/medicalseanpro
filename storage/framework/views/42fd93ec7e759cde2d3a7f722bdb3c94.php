...
<body>
                                    ...
                                    <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($now->lt($appointmentEnd)): ?>
                                            ...
                                            <div class="appointment-wrap upcoming-appointment-item" 
                                                 data-patient-name="<?php echo e(strtolower($patient->name ?? '')); ?>" 
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="patinet-information">
                                                            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#appointmentDetailsModal<?php echo e($booking->id); ?>">
                                                                <img src="<?php echo e(asset($booking->patient->profile->dp  ?? 'images/profile-06.jpg')); ?>" alt="<?php echo e($patient->name ?? 'Patient'); ?>" onerror="this.src='<?php echo e(asset('images/default.jpeg')); ?>'">
                                                            </a>
                                                            <div class="patient-info">
                                                                <p>#APT000<?php echo e($booking->id); ?></p>
                                                                <h6>
                                                                    <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#appointmentDetailsModal<?php echo e($booking->id); ?>">
                                                                        <?php echo e($patient->name ?? 'Unknown Patient'); ?>
                                                    ...
                                                    <li class="mail-info-patient">
                                                        <ul>
                                                            <li><i class="isax isax-sms5"></i><?php echo e($patient->email ?? 'No email'); ?></li>
                                                            <li><i class="isax isax-call5"></i><?php echo e($patient->phone ?? 'No phone'); ?></li>
                                                        </ul>
                                                    </li>
                                                    ...
                                                    <li class="appointment-action">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('doctor.chat', ['booking' => $booking->id])); ?>" data-bs-toggle="tooltip" title="Chat">
                                                        ...
                                                        <li class="appointment-detail-btn">
                                                            <a href="
                                                                <?php if($booking->appointment_type == 'chat'): ?>
                                                                    <?php echo e(route('doctor.chat', ['booking' => $booking->id])); ?>
                                                                ...
                                                                <?php elseif($booking->appointment_type == 'home'): ?>
                                                                    <?php echo e(route('doctor.home', ['booking' => $booking->id])); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="d-flex align-items-center mb-4">
                                                                        <img src="<?php echo e(asset($booking->patient->profile->dp ?? 'images/profile-06.jpg')); ?>" 
                                                                        ...
                                                                        <div>
                                                                            <h4 class="mb-1"><?php echo e($patient->name ?? 'Unknown Patient'); ?></h4>
                                                                            <p class="text-muted mb-1">Patient ID: #PAT<?php echo e(str_pad($patient->id ?? '0', 4, '0', STR_PAD_LEFT)); ?></p>
                                                                            <?php if($now->between($appointmentStart, $appointmentEnd)): ?>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <ul class="info-details">
                                                                        <li>
                                                                            ...
                                                                            <span class="text"><?php echo e($patient->name ?? 'N/A'); ?></span>
                                                                        </li>
                                                                        <li>
                                                                            <span class="title">Email:</span>
                                                                            <span class="text"><?php echo e($patient->email ?? 'N/A'); ?></span>
                                                                        </li>
                                                                        <li>
                                                                            <span class="title">Phone:</span>
                                                                            <span class="text"><?php echo e($patient->phone ?? 'N/A'); ?></span>
                                                                        </li>
                                                                        <li>
                                                                            <span class="title">Gender:</span>
                                                                            <span class="text"><?php echo e($patient->gender ?? 'N/A'); ?></span>
                                                                        </li>
                                                                        <li>
                                                                            <span class="title">Age:</span>
                                                                            <span class="text">
                                                                                <?php if($patient->date_of_birth): ?>
                                                                                    <?php echo e(Carbon::parse($patient->date_of_birth)->age); ?> years
                                                                                <?php else: ?>
                                                                                    N/A
                                                                                <?php endif; ?>
                                                                            </span>
                                                    ...
                                                    <li>
                                                        <div class="patinet-information">
                                                            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#completedAppointmentModal<?php echo e($booking->id); ?>">
                                                                <img src="<?php echo e(asset($booking->patient->profile->dp ?? 'images/profile-06.jpg')); ?>" onerror="this.src='<?php echo e(asset('images/default.jpeg')); ?>'">
                                                            </a>
                                                            <div class="patient-info">
                                                                <p>#APT000<?php echo e($booking->id); ?></p>
                                                                <h6>
    ...
    <script>
        ...
        function openFocusedBookingModal() {
            const focusedBookingId = <?php echo json_encode(request('focus_booking'), 15, 512) ?>;
...
<?php /**PATH /Users/dope/Downloads/public_htm/resources/views/doctor/appointment.blade.php ENDPATH**/ ?>