...
<body>
                                ...
                                <div class="accordion-collapse collapse show" id="cardiology"
                                    ...
                                    <div class="content-collapse">
                                        <div class="add-service-info">
                                            <form method="POST" action="<?php echo e(route('specialities.store')); ?>">
                                                <?php echo csrf_field(); ?>
    ...
    <!-- jQuery -->
    <script src="<?php echo e(asset('js/jquery-3.7.1.min.js')); ?>" type="c8b21093f66fafa8aee5be31-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="<?php echo e(asset('js/bootstrap.bundle.min.js')); ?>" type="c8b21093f66fafa8aee5be31-text/javascript"></script>

    <!-- Sticky Sidebar JS -->
    <script src="<?php echo e(asset('js/ResizeSensor.js')); ?>" type="c8b21093f66fafa8aee5be31-text/javascript"></script>
    <script src="<?php echo e(asset('js/theia-sticky-sidebar.js')); ?>" type="c8b21093f66fafa8aee5be31-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="<?php echo e(asset('js/select2.min.js')); ?>" type="c8b21093f66fafa8aee5be31-text/javascript"></script>

    <!-- Datepicker JS -->
    <script src="<?php echo e(asset('js/moment.min.js')); ?>" type="c8b21093f66fafa8aee5be31-text/javascript"></script>
    <script src="<?php echo e(asset('js/bootstrap-datetimepicker.min.js')); ?>"
        type="c8b21093f66fafa8aee5be31-text/javascript"></script>

    <!-- Custom JS -->
    <script src="<?php echo e(asset('js/profile-settings.js')); ?>" type="c8b21093f66fafa8aee5be31-text/javascript"></script>
    <script src="<?php echo e(asset('js/script.js')); ?>" type="c8b21093f66fafa8aee5be31-text/javascript"></script>

    <script src="<?php echo e(asset('js/rocket-loader.min.js')); ?>" data-cf-settings="c8b21093f66fafa8aee5be31-|49"
        defer=""></script>
    <script defer=""
...
</html><?php /**PATH /home/u881803686/domains/medicalsean.org/public_html/resources/views/doctor/specialities.blade.php ENDPATH**/ ?>