							...
							<div id="chats" class="left-sidebar-wrap sidebar active slimscroll">
								...
								<div class="slimscroll-active-sidebar">
									...
									<div class="sidebar-body chat-body" id="chatsidebar">
										...
										<!-- /Left Chat Title -->
										<ul class="user-list">
											<?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookingId => $chatMessages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<?php
												...
												<li class="user-list-item">
													<a
														href="<?php echo e(route('doctor.chat', ['booking' => $chatMessages->first()->booking_id])); ?>">
														<div class="avatar avatar-online">
															<img src="<?php echo e(asset('images/default.jpeg')); ?>" alt="image">
														</div>
														<div class="users-list-body">
															<div>
																<h5><?php echo e($patient->name ?? 'Unknown Patient'); ?></h5>
															...
															<div class="last-chat-time">
																...
																<div class="new-message-count">
																	<?php echo e($chatMessages->where('receiver_id', Auth::id())->count()); ?>
						...
						<div class="chat chat-messages" id="middle">
								...
								<div class="chat-inner-header">
									<div class="chat-header">
										<div class="user-details">
											...
											<div class="mt-1">
												<h5><?php echo e($messages[1]?->booking?->patient?->name ?? 'Unknown patient'); ?>
												...
												<div class="chat-line">
													<span class="chat-date">
														...
														<?php elseif($msg->created_at->isYesterday()): ?>
															Yesterday
														<?php else: ?>
															<?php echo e($msg->created_at->format('F d, Y')); ?>
												...
												<div class="chats">
													...
													<div class="chat-content">
														<div class="chat-profile-name">
															<h6>
																<?php echo e($messages[1]?->booking?->patient?->name ?? 'Unknown patient'); ?>
							...
							<div class="chat-footer">
								<form action="<?php echo e(route('chat.store')); ?>" method="POST">
									...
									<!-- Hidden fields -->
									<input type="hidden" name="receiver_id" value="<?php echo e($patient?->id ?? ''); ?>">
...
document.querySelector('#chat-form').addEventListener('submit', async (e) => {
	...
	<!-- jQuery -->
	<script src="<?php echo e(asset('js/jquery-3.7.1.min.js')); ?>" type="adb2f76b2b117580fbcae61a-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="<?php echo e(asset('js/bootstrap.bundle.min.js')); ?>" type="adb2f76b2b117580fbcae61a-text/javascript"></script>

	<!-- Swiper JS -->
	<script src="<?php echo e(asset('js/swiper.min.js')); ?>" type="adb2f76b2b117580fbcae61a-text/javascript"></script>

	<!-- Custom JS -->
	<script src="<?php echo e(asset('js/script.js')); ?>" type="adb2f76b2b117580fbcae61a-text/javascript"></script>

	<script src="<?php echo e(asset('js/rocket-loader.min.js')); ?>" data-cf-settings="adb2f76b2b117580fbcae61a-|49" defer=""></script>
	<script defer=""
		src="<?php echo e(asset('https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015')); ?>"
		data-cf-beacon="{"
...
</html><?php /**PATH /home/u881803686/domains/medicalsean.org/public_html/resources/views/doctor/chat.blade.php ENDPATH**/ ?>