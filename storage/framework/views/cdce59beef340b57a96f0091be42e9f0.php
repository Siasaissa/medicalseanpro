...
<!-- Primary Meta -->
<title>MedicalSean – Online Doctor Consultation, Video Call, Chat & Home Visit</title>
<meta name="description" content="MedicalSean allows you to book online doctor appointments via video call, voice call or chat. Get home visit services, order medical supplies, and access trusted healthcare anytime.">
<meta name="keywords" content="online doctor, doctor appointment Tanzania, video call doctor, medical consultation, telemedicine, home visit doctor, buy medicine online, MedicalSean">
<meta name="author" content="MedicalSean">

<!-- Open Graph (Facebook / WhatsApp) -->
<meta property="og:url" content="https://medicalsean.org">
<meta property="og:type" content="website">
<meta property="og:title" content="MedicalSean – Book Online Doctors Instantly">
<meta property="og:description" content="Consult doctors via video call, voice call or chat. Book home visits & order medical supplies easily with MedicalSean.">
<meta property="og:image" content="https://medicalsean.org/images/preview-banner.jpg">

<!-- Twitter Card -->
<meta name="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="https://medicalsean.org">
<meta name="twitter:title" content="MedicalSean – Online Medical Consultation">
<meta name="twitter:description" content="Book doctor appointments online via video, audio or chat. Get home visits and order medications fast.">
<meta name="twitter:image" content="https://medicalsean.org/images/preview-banner.jpg">
						...
						<div class="header-menu">
							<div class="main-menu-wrapper">
								...
								<ul class="main-nav">
									...
									<li class="menu">
										<a href="<?php echo e(route('register')); ?>">Register</i></a>
									</li>
					...
					<div class="list-card card mb-0">
						<div class="card-body">
							<div class="d-flex align-items-center justify-content-center justify-content-xl-between flex-wrap gap-4 list-wraps">
								<a href="<?php echo e(route('patient.appointment')); ?>" class="list-item aos" data-aos="fade-up">
								...
								<a href="<?php echo e(route('login')); ?>" class="list-item aos" data-aos="fade-up">
