...
<body>
                        ...
                        <div class="card">
                            <div class="card-body custom-edit-service">
                                ...
                                <form enctype="multipart/form-data" autocomplete="off" id="update_service"
                                    action="<?php echo e(route('products.store')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
    ...
    <script src="<?php echo e(asset('js/rocket-loader.min.js')); ?>" data-cf-settings="d2241dbc8fbf4e82f8c24724-|49"
        defer=""></script>
    <script defer=""
...
</html><?php /**PATH /Users/dope/Downloads/public_htm/resources/views/admin/AddProduct.blade.php ENDPATH**/ ?>