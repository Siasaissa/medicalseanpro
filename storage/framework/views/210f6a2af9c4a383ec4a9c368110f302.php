...
<body class="g-sidenav-show bg-gray-100">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center ms-3">
                            ...
                            <p class="text-xs text-secondary mb-0">ID: <?php echo e($product->id ?? 'N/A'); ?></p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0">Tsh <?php echo e(number_format($product->price, 2)); ?></p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-<?php echo e($product->stock > 10 ? 'success' : ($product->stock > 0 ? 'warning' : 'danger')); ?>">
                          <?php echo e($product->stock ?? 'N/A'); ?>

                        </span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo e($product->unit ?? 'N/A'); ?></span>
                      </td>
                      <td class="align-middle text-center">
                        <?php if($product->image): ?>
                          <div class="avatar avatar-sm me-3">
                            <img src="<?php echo e($product->image ? url('storage/' . $product->image) : url('img/defaultmedical.jpg')); ?>" alt="<?php echo e($product->name); ?>" class="border-radius-sm" style="width: 60px; height: 60px; object-fit: cover;">
                          </div>
                        <?php else: ?>
                      ...
                      <td class="align-middle text-center">
                        ...
                        <button 
                          ...
                          data-update-url="<?php echo e(route('admin.products.update', $product->id)); ?>">
                          <i class="material-symbols-rounded opacity-10">edit</i>
                        </button>

                        <!-- Delete Form -->
                        <form action="<?php echo e(route('admin.products.destroy', $product->id)); ?>" method="POST" class="d-inline-block delete-form">
                          <?php echo csrf_field(); ?>
  ...
  <div class="modal fade" id="uploadExcelModal" tabindex="-1" aria-labelledby="uploadExcelModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <form action="<?php echo e(route('admin.products.uploadExcel')); ?>" method="POST" enctype="multipart/form-data" id="uploadExcelForm">
          <?php echo csrf_field(); ?>
          ...
          <div class="modal-body">
            ...
            <div class="alert alert-info">
              <small>
                ...
                Download <a href="<?php echo e(asset('templates/products_template.xlsx')); ?>" class="text-primary">Excel template</a> for proper formatting
              </small>
            </div>
          </div>
  ...
  <div class="modal fade" id="addProductModal" tabindex="-1" aria-labelledby="addProductModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <form action="<?php echo e(route('admin.products.store')); ?>" method="POST" enctype="multipart/form-data" id="addProductForm">
          <?php echo csrf_field(); ?>
        ...
        <form method="POST" enctype="multipart/form-data" id="editProductForm">
          ...
          <div class="modal-body">
            ...
            <div id="currentImageContainer" class="mb-3 d-none">
              <div class="mt-2">
                <img id="currentProductImage" src="<?php echo e($product->image ? url('storage/' . $product->image) : url('img/defaultmedical.jpg')); ?>" alt="Current Image" class="img-thumbnail" style="max-width: 100px;">
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      editButtons.forEach(button => {
        button.addEventListener('click', function() {
          ...
          if (productImage) {
            const imageUrl = "<?php echo e(asset('storage/')); ?>/" + productImage;
...
</html><?php /**PATH /Users/dope/Downloads/public_htm/resources/views/admin/products/index.blade.php ENDPATH**/ ?>