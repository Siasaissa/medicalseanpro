                                            ...
                                            <div class="user-details">
                                                <div class="user-info">
                                                    <span style="color: red;">Doctor:
                                                        <?php echo e($booking->doctor->name); ?></span> ||
            ...
            try {
                ...
                document.getElementById('loading-message').innerHTML = `
                    <div style="color: red; padding: 20px;">
                        ...
                        <p>${error.message}</p>
                        <a href="<?php echo e(route('doctor.appointment')); ?>" class="btn btn-primary mt-2">← Back</a>
                    </div>`;
            }
        });
    </script>
...
<?php /**PATH /Users/dope/Downloads/public_htm/resources/views/doctor/voice.blade.php ENDPATH**/ ?>