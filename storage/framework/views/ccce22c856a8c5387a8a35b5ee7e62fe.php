...
<body class="main-chat-blk">
                    ...
                    <div class="chat-sec">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bId => $chatData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                ...
                                                <?php if($doctor && $lastMessage): ?>
                                                    <li class="user-list-item chat-user-item <?php echo e($isActive ? 'active' : ''); ?>" 
                                                        ...
                                                        <a href="<?php echo e(route('chat.index', ['booking' => $booking->id])); ?>"
                                                           onclick="handleChatClick(event, <?php echo e($booking->id); ?>)">
                                                            <div class="avatar <?php echo e($doctor->is_online ? 'avatar-online' : 'avatar-offline'); ?>">
                                                                <img src="<?php echo e($doctorImage); ?>" alt="<?php echo e($doctor->name); ?>" style="border-radius: 50%;">
                                                            </div>
                                                            <div class="users-list-body">
                                                                <div>
                                                                    <h5><?php echo e($doctor->name); ?></h5>
                                                                    <p class="last-message"><?php echo e(Str::limit($lastMessage->message, 30)); ?></p>
                                                                </div>
                        ...
                        <div class="chat chat-messages" id="chatMessages">
                                ...
                                <div class="chat-inner-header">
                                    <div class="chat-header">
                                        <div class="user-details">
                                            ...
                                            ?>
                                            <figure class="avatar <?php echo e($activeDoctor?->is_online ? 'avatar-online' : 'avatar-offline'); ?>">
                                                <img src="<?php echo e($activeDoctorImage); ?>" alt="<?php echo e($activeDoctor?->name ?? 'Doctor'); ?>" id="currentDoctorImage" style="border-radius: 50%;">
                                            </figure>
                                            <div class="mt-1" style="z-index: 999">
                                                <h5 id="currentDoctorName"><?php echo e($activeDoctor?->name ?? 'Select a chat'); ?></h5>
                                                <small class="last-seen" id="doctorStatus">
                                                    <?php if($activeDoctor): ?>
                                                        <span class="online-status <?php echo e($activeDoctor->is_online ? 'text-success' : 'text-secondary'); ?>">
                                                            <?php echo e($activeDoctor->is_online ? '● Online' : '○ Offline'); ?>
                                                ...
                                                <?php if($msg->sender_id == Auth::id()): ?>
                                                    ...
                                                    <div class="chats chats-right" data-message-id="<?php echo e($msg->id); ?>" data-read="<?php echo e($msg->is_read ? '1' : '0'); ?>" data-read-at="<?php echo e($msg->read_at); ?>">
                                                        ...
                                                        <div class="chat-avatar">
                                                            <img src="<?php echo e($senderImage); ?>" class="dreams_chat" alt="<?php echo e($senderName); ?>" style="border-radius: 50%;">
                                                        </div>
                                                    </div>
                                                <?php else: ?>
                            ...
                            <div class="chat-footer">
                                ...
                                <?php if($activeBookingId && $activeDoctorId): ?>
                                    <form action="<?php echo e(route('chat.store1')); ?>" method="POST" id="chatForm">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="receiver_id" id="receiverId" value="<?php echo e($activeDoctorId); ?>">
                                        ...
                                        <input type="text" name="message" class="form-control chat_form" id="messageInput"
                                            placeholder="<?php echo e($isChatSessionActive ? 'Type your message here...' : 'Session ended. Please create a new booking.'); ?>"
                                        ...
                                        <div class="form-buttons">
                                            <button class="btn send-btn" type="button" id="sendMessageBtn" onclick="sendMessage()"
                                                <?php echo e($isChatSessionActive ? '' : 'disabled'); ?>>
    ...
    <script>
        ...
        const CONFIG = {
            ...
            sessionRedirectUrl: '<?php echo e(route('patient.appointment')); ?>'
        };
        ...
        function handleChatClick(event, bookingId) {
            ...
            window.location.href = `<?php echo e(route('chat.index')); ?>?booking=${bookingId}`;
        }
        ...
        function updatePageTitle(totalUnread) {
            const baseTitle = 'Chat - <?php echo e(config("app.name")); ?>';
    ...
    <script src="<?php echo e(asset('js/rocket-loader.min.js')); ?>" data-cf-settings="87d100b3f0de52923242b24d-|49" defer></script>
</body>
</html>
<?php /**PATH /Users/dope/Downloads/public_htm/resources/views/patient/chat.blade.php ENDPATH**/ ?>