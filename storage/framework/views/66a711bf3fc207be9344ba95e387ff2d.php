...
<body class="call-page">
                                ...
                                <div class="call-window">
                                    ...
                                    <div class="fixed-header">
                                        <div class="navbar d-flex justify-content-between align-items-center">
                                            <div class="user-details">
                                                <div class="user-info">
                                                    <span style="color: red;">Doctor: <?php echo e($booking->doctor->name); ?></span> ||
                                    ...
                                    <div class="call-contents">
                                        <div class="call-content-wrap">
                                                ...
                                                <div id="voice-call" style="width: 100%; height: 500px; background: #000;"></div>
                                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', async () => {
            try {
                ...
                fetch(`<?php echo e(route('call.invite', ['booking' => $booking->id])); ?>`, {
                    method: 'POST',
                    headers: {
                ...
                const roomID = "voice_booking_<?php echo e($booking->id); ?>";
                const tokenRes = await fetch(`/api/zego-token?booking_id=<?php echo e($booking->id); ?>`);
                if (!tokenRes.ok) {
                ...
                document.getElementById('loading-message').innerHTML = `
                    <div style="color: red; padding: 20px;">
                        ...
                        <p>${error.message}</p>
                        <a href="<?php echo e(route('patient.appointment')); ?>" class="btn btn-primary mt-2">← Back</a>
                    </div>`;
            }
        });
    </script>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const serviceString = "<?php echo e($booking->service_time); ?>"; // numeric like 20, 40, 60
            const appointmentStart = new Date("<?php echo e($booking->appointment_datetime); ?>");
...
<?php /**PATH /Users/dope/Downloads/public_htm/resources/views/patient/voice.blade.php ENDPATH**/ ?>