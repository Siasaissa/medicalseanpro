										...
										<div class="col-xxl-7 col-lg-7">
											<div class="account-payment-info">
												...
												<div class="payment-request">
													<span>Last Payment Request: <?php echo e($history->first()->appointment_datetime); ?></span>
												...
												<table class="table table-center mb-0">
													...
													<tbody>
														...
														<tr>
															...
															<td><?php echo e($transact->appointment_type); ?></td>
															<td><?php echo e($transact->appointment_datetime); ?></td>
														<td><?php echo e(number_format($transact->service_price,2)); ?></td>
														<?php if( $transact->appointment_datetime < now() ): ?>
															<td>
...
</body></html><?php /**PATH /home/u881803686/domains/medicalsean.org/public_html/resources/views/patient/wallet.blade.php ENDPATH**/ ?>