<!DOCTYPE html><html lang="en"><head>
		...
		<meta name="description" content="The responsive professional MedicalSean template offers many features, like scheduling appointments with  top doctors, clinics, and hospitals via voice, video call & chat.">
		<meta name="keywords" content="practo clone, MedicalSean, doctor appointment, Practo clone html template, doctor booking template">
		<meta name="author" content="Practo Clone HTML Template - Doctor Booking Template">
		<meta property="og:url" content="https://MedicalSean.dreamstechnologies.com/html/">
		<meta property="og:type" content="website">
		<meta property="og:title" content="Doctors Appointment HTML Website Templates | MedicalSean">
		<meta property="og:description" content="The responsive professional MedicalSean template offers many features, like scheduling appointments with  top doctors, clinics, and hospitals via voice, video call & chat.">
		<meta property="og:image" content="images/preview-banner.jpg">
		<meta name="twitter:card" content="summary_large_image">
		<meta property="twitter:domain" content="https://MedicalSean.dreamstechnologies.com/html/">
		<meta property="twitter:url" content="https://MedicalSean.dreamstechnologies.com/html/">
		<meta name="twitter:title" content="Doctors Appointment HTML Website Templates | MedicalSean">
		<meta name="twitter:description" content="The responsive professional MedicalSean template offers many features, like scheduling appointments with  top doctors, clinics, and hospitals via voice, video call & chat.">
		<meta name="twitter:image" content="assets/img/preview-banner.jpg">
		<title>MedicalSean</title>
		...
		<!-- Theme Settings Js -->
		<script src="js/theme-script.js" type="ba4f4e0a45006c59f1e697b9-text/javascript"></script>
	...
	<body>
		...
		<div class="main-wrapper">
							...
							<li class="d-inline-flex align-items-center drop-header">
								<div class="dropdown dropdown-country me-3">
									<a href="javascript:void(0);" class="d-inline-flex align-items-center" data-bs-toggle="dropdown" aria-expanded="false">
										<img src="images/us-flag.svg" class="me-2" alt="flag">
									</a>
									<ul class="dropdown-menu p-2 mt-2">
										<li>
											<a class="dropdown-item rounded d-flex align-items-center" href="javascript:void(0);">
												<img src="images/Tanzania.svg" class="me-2" alt="flag">Sw
											</a>
										</li>
										<li>
											<a class="dropdown-item rounded d-flex align-items-center" href="javascript:void(0);">
												<img src="images/us-flag.svg" class="me-2" alt="flag">Eng
											</a>
										</li>
								...
								<div class="dropdown dropdown-amt">
									...
									<ul class="dropdown-menu p-2 mt-2">
										<li><a class="dropdown-item rounded" href="javascript:void(0);">Sw</a></li>
					...
					<nav class="navbar navbar-expand-lg header-nav">
						...
						<div class="header-menu">
							...
							<ul class="nav header-navbar-rht">
								...
								<li>
									<a href="<?php echo e(route('login')); ?>" class="btn btn-md btn-primary-gradient d-inline-flex align-items-center rounded-pill"><i class="isax isax-lock-1 me-1"></i>Login</a>
								</li>
								<li>
			...
			<section class="banner-section banner-sec-one">
					...
					<div class="row align-items-center">
						<div class="col-lg-7">
							<div class="banner-content aos" data-aos="fade-up">
								...
								<h1 class="display-5">Discover Health: Find Your Trusted <span class="banner-icon"><img src="images/video.svg" alt="img"></span> <span class="text-gradient">Doctors</span> Today</h1>
						...
						<div class="col-lg-5">
							<div class="banner-img aos" data-aos="fade-up">
								<img src="images/doctori.png" class="img-fluid" alt="patient-image">
				...
				<div class="banner-bg">
					<img src="images/banner-bg-02.png" alt="img" class="banner-bg-01">
					<img src="images/banner-bg-03.png" alt="img" class="banner-bg-02">
					<img src="images/banner-bg-04.png" alt="img" class="banner-bg-03">
					<img src="images/banner-bg-05.png" alt="img" class="banner-bg-04">
					...
					<div class="list-card card mb-0">
						<div class="card-body">
							<div class="d-flex align-items-center justify-content-center justify-content-xl-between flex-wrap gap-4 list-wraps">
								<a href="doctor-grid01.html" class="list-item aos" data-aos="fade-up">
									<div class="list-icon bg-secondary">
										<img src="images/list-icon-01.svg" alt="img">
									</div>
									<h6>Book Appointment</h6>
								</a>
								<a href="chat.html" class="list-item aos" data-aos="fade-up">
									<div class="list-icon bg-primary">
										<img src="images/list-icon-02.svg" alt="img">
									</div>
									<h6>Talk to Doctors</h6>
								</a>
								
								
								<a href="product-all.html" class="list-item aos" data-aos="fade-up">
									<div class="list-icon bg-purple">
										<img src="images/list-icon-05.svg" alt="img">
									</div>
					...
					<div class="owl-carousel spciality-slider aos" data-aos="fade-up">
						<div class="spaciality-item">
							<div class="spaciality-img">
								<img src="images/speciality-01.jpg" alt="img">
								<span class="spaciality-icon">
									<img src="images/speciality-icon-01.svg" alt="img">
								</span>
							</div>
						...
						<div class="spaciality-item">
							<div class="spaciality-img">
								<img src="images/speciality-02.jpg" alt="img">
								<span class="spaciality-icon">
									<img src="images/speciality-icon-02.svg" alt="img">
								</span>
							</div>
						...
						<div class="spaciality-item">
							<div class="spaciality-img">
								<img src="images/speciality-03.jpg" alt="img">
								<span class="spaciality-icon">
									<img src="images/speciality-icon-03.svg" alt="img">
								</span>
							</div>
						...
						<div class="spaciality-item">							
							<div class="spaciality-img">
								<img src="images/speciality-04.jpg" alt="img">
								<span class="spaciality-icon">
									<img src="images/speciality-icon-04.svg" alt="img">
								</span>
							</div>
						...
						<div class="spaciality-item">						
							<div class="spaciality-img">
								<img src="images/speciality-05.jpg" alt="img">
								<span class="spaciality-icon">
									<img src="images/speciality-icon-05.svg" alt="img">
								</span>
							</div>
						...
						<div class="spaciality-item">													
							<div class="spaciality-img">
								<img src="images/speciality-06.jpg" alt="img">
								<span class="spaciality-icon">
									<img src="images/speciality-icon-06.svg" alt="img">
								</span>
							</div>
						...
						<div class="spaciality-item">						
							<div class="spaciality-img">
								<img src="images/speciality-07.jpg" alt="img">
								<span class="spaciality-icon">
									<img src="images/speciality-icon-07.svg" alt="img">
								</span>
							</div>
						...
						<div class="spaciality-item">						
							<div class="spaciality-img">
								<img src="images/speciality-08.jpg" alt="img">
								<span class="spaciality-icon">
									<img src="images/speciality-icon-08.svg" alt="img">
								</span>
							</div>
							...
							<div class="bookus-img">
								<div class="row g-3">
									<div class="col-md-12 aos" data-aos="fade-up">
										<img src="images/book-01.jpg" alt="img" class="img-fluid">
									</div>
									<div class="col-sm-6 aos" data-aos="fade-up">
										<img src="images/book-02.jpg" alt="img" class="img-fluid">
									</div>
									<div class="col-sm-6 aos" data-aos="fade-up">
										<img src="images/book-03.jpg" alt="img" class="img-fluid">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row g-4">
							<div class="col-lg-3">
								<div class="book-item">
									...
									<div class="way-icon">
										<img src="images/way-icon.svg" alt="img">
									</div>
								</div>
							</div>
							<div class="col-lg-3">
					...
					<div class="row g-4">
							...
							<div class="article-item aos" data-aos="fade-up">
								<div class="article-img">
									<a href="blog-details.html">
										<img src="images/article-01.jpg" class="img-fluid" alt="img">
									</a>
									<div class="date-icon">
										<span>15</span>May
									</div>
						...
						<div class="col-lg-6">
							<div class="article-item aos" data-aos="fade-up">
								<div class="article-img">
									<a href="blog-details.html">
										<img src="images/article-02.jpg" class="img-fluid" alt="img">
									</a>
									<div class="date-icon">
										<span>18</span>May
									</div>
						...
						<div class="col-lg-6">
							<div class="article-item aos" data-aos="fade-up">
								<div class="article-img">
									<a href="blog-details.html">
										<img src="images/article-03.jpg" class="img-fluid" alt="img">
									</a>
									<div class="date-icon">
										<span>21</span>Apr
									</div>
						...
						<div class="col-lg-6">
							<div class="article-item aos" data-aos="fade-up">
								<div class="article-img">
									<a href="blog-details.html">
										<img src="images/article-04.jpg" class="img-fluid" alt="img">
									</a>
									<div class="date-icon">
										<span>22</span>Jan
									</div>
							...
							<div class="d-sm-flex align-items-center justify-content-lg-end gap-4 aos" data-aos="fade-up">
								<div class="con-info d-flex align-items-center mb-3 mb-sm-0">
									...
									<div class="ms-2">
										...
										<p class="text-white fw-medium mb-0">+255 613803662</p>
									</div>
								</div>
								<div class="con-info d-flex align-items-center">
									...
									<div class="ms-2">
										...
										<p class="text-white fw-medium mb-0"><a href="/cdn-cgi/l/email-protection" class="__cf_email__">dopehacker051@gmail.com</a></p>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- jQuery -->
		<script data-cfasync="false" src="js/email-decode.min.js"></script><script src="js/jquery-3.7.1.min.js" type="ba4f4e0a45006c59f1e697b9-text/javascript"></script>
		
		<!-- Bootstrap Bundle JS -->
		<script src="js/bootstrap.bundle.min.js" type="ba4f4e0a45006c59f1e697b9-text/javascript"></script>
		
		<!-- Feather Icon JS -->
		<script src="js/feather.min.js" type="ba4f4e0a45006c59f1e697b9-text/javascript"></script>

		<!-- select JS -->
		<script src="js/select2.min.js" type="ba4f4e0a45006c59f1e697b9-text/javascript"></script>

		<!-- Datepicker JS -->
		<script src="js/moment.min.js" type="ba4f4e0a45006c59f1e697b9-text/javascript"></script>
		<script src="js/bootstrap-datetimepicker.min.js" type="ba4f4e0a45006c59f1e697b9-text/javascript"></script>

		<!-- Owl Carousel JS -->
		<script src="js/owl.carousel.min.js" type="ba4f4e0a45006c59f1e697b9-text/javascript"></script>

		<!-- Counter JS -->
		<script src="js/counter.js" type="ba4f4e0a45006c59f1e697b9-text/javascript"></script>

		<!-- Animation JS -->
		<script src="js/aos.js" type="ba4f4e0a45006c59f1e697b9-text/javascript"></script>
				
		<!-- Custom JS -->
		<script src="js/script.js" type="ba4f4e0a45006c59f1e697b9-text/javascript"></script>
...
</body></html><?php /**PATH /Users/dope/Documents/sean/sean/resources/views/welcome.blade.php ENDPATH**/ ?>