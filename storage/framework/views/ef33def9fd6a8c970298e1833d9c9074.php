                    ...
                    <div class="header-menu">
                        <div class="main-menu-wrapper">
                            ...
                            <ul class="main-nav">
                                ...
                                <li class="menu active"><a href="<?php echo e(route('about.us')); ?>">About Us</a></li>
                                <li class="menu"><a href="<?php echo e(route('blog.grid')); ?>">Blog Grid</a></li>
            ...
            <div class="container">
                <div class="row align-items-center mb-5">
                    <div class="col-lg-6">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-primary-gradient rounded-pill">Get Started</a>
                    </div>
                    <div class="col-lg-6 mt-4 mt-lg-0">
                        <img src="<?php echo e(asset('images/about-us.png')); ?>" alt="About MedicalSean" class="img-fluid rounded-3"
                            onerror="this.src='<?php echo e(asset('images/login-banner.png')); ?>'">
                    </div>
                </div>
                ...
                <div class="text-center mb-4">
                    <a href="<?php echo e(route('blog.grid')); ?>" class="btn btn-dark rounded-pill me-2">Read Health Blog</a>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-primary-gradient rounded-pill">Book Consultation</a>
                </div>
            </div>
        </div>
...
<?php /**PATH /Users/dope/Downloads/public_htm/resources/views/about-us.blade.php ENDPATH**/ ?>