	...
	<div class="main-wrapper">
		...
		<div class="breadcrumb-bar overflow-visible">
			...
			<div class="breadcrumb-bg">
				<img src="<?php echo e(asset('images/breadcrumb-bg-01.pn')); ?>g" alt="img" class="breadcrumb-bg-01">
...
<?php endif; ?>
							...
							<div class="col-xxl-4 col-md-6">
								<div class="card">
									<div class="card-img card-img-hover">
										<img src="<?php echo e(asset($doctors->profile->dp)); ?>" alt="">
									...
									<div class="card-body p-0">
										<div class="d-flex active-bar align-items-center justify-content-between p-3">
											<a href="#" class="text-indigo fw-medium fs-14"><?php echo e($doctors->profile->speciality); ?></a>
											<?php if($doctors->profile->availability == 'available'): ?>
											<span class="badge bg-success-light d-inline-flex align-items-center">
												<i class="fa-solid fa-circle fs-5 me-1"></i>
												Available
											</span>
											<?php elseif($doctors->profile->availability == 'not_available'): ?>
										...
										<div class="p-3 pt-0">
											<div class="doctor-info-detail mb-3 pb-3">
												<h3 class="mb-1">Dr.<?php echo e($doctors->name); ?></h3>
												<div class="d-flex align-items-center">
													<p class="d-flex align-items-center mb-0 fs-14"><i class="isax isax-location me-2"></i><?php echo e($doctors->profile->address ?? 'Not yet'); ?></p>
											...
											<div class="d-flex align-items-center justify-content-between">
												...
												<a href="<?php echo e(route('patient.booking', ['doctor' => $doctors->id])); ?>" 
	...
	<!-- jQuery -->
	<script src="js/jquery-3.7.1.min.js" type="07376c6329b84ec49a5fbc3b-text/javascript"></script>

	<!-- Bootstrap Bundle JS -->
	<script src="js/bootstrap.bundle.min.js" type="07376c6329b84ec49a5fbc3b-text/javascript"></script>

	<!-- Feather Icon JS -->
	<script src="js/feather.min.js" type="07376c6329b84ec49a5fbc3b-text/javascript"></script>

	<!-- Rangeslider JS -->
	<script src="js/ion.rangeSlider.js" type="07376c6329b84ec49a5fbc3b-text/javascript"></script>
	<script src="js/custom-rangeslider.js" type="07376c6329b84ec49a5fbc3b-text/javascript"></script>
	<script src="js/ion.rangeSlider.min.js" type="07376c6329b84ec49a5fbc3b-text/javascript"></script>

	<!-- Datepicker JS -->
	<script src="js/moment.min.js" type="07376c6329b84ec49a5fbc3b-text/javascript"></script>
	<script src="js/bootstrap-datetimepicker.min.js" type="07376c6329b84ec49a5fbc3b-text/javascript"></script>

	<!-- Custom JS -->
	<script src="js/script.js" type="07376c6329b84ec49a5fbc3b-text/javascript"></script>
...
</body></html><?php /**PATH /Users/dope/Documents/sean/sean/resources/views/patient/doctor-grid.blade.php ENDPATH**/ ?>