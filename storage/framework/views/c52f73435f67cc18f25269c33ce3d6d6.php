								...
								<ul class="nav nav-pills inner-tab " id="pills-tab" role="tablist">
									<li class="nav-item" role="presentation">
										<button class="nav-link active" id="pills-upcoming-tab" data-bs-toggle="pill"
											...
											aria-selected="false">Active<span><?php echo e($total); ?></span></button>
									</li>
								</ul>
							</div>
						...
						<div class="tab-content appointment-tab-content grid-patient">
							<div class="tab-pane fade show active" id="pills-upcoming" role="tabpanel"
								...
								<div class="row">
									...
									<!-- Appointment Grid -->
									<?php $__currentLoopData = $Mypatient; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										...
										<div class="appointment-wrap appointment-grid-wrap">
											<ul>
													...
													<div class="appointment-grid-head">
														<div class="patinet-information">
															<a href="patient-profile.html">
																<img src="<?php echo e(isset($patient->patient->profile->dp) && file_exists(public_path($patient->patient->profile->dp))
															...
															<div class="patient-info">
																<p>#Apt000<?php echo e($patient->patient->id); ?></p>
																<h6><a
																		href="patient-profile.html"><?php echo e($patient->patient->name); ?></a>
																</h6>
																<ul>
																	<?php
																	...
																	<li>Age : <?php echo e($ageText); ?></li>
																	<li>Sex: <?php echo e($patient->patient->profile->sex ?? 'Not set'); ?>

																	</li>
																	<li>Blood Group: <?php echo e($patient->patient->profile->blood_group ?? 'Not set'); ?>
												...
												<li class="appointment-info">
													<p><i class="isax isax-clock5"></i>Join : <?php echo e($patient->patient->created_at); ?></p>
													<p class="mb-0"><i class="isax isax-location5"></i><?php echo e($patient->patient->profile->address); ?></p>
												</li>
												<li class="appointment-action">
													<div class="patient-book">
														<p><i class="isax isax-calendar-1"></i>Last Booking <span><?php echo e(\Carbon\Carbon::parse($patient->last_appointment)->format('M d, Y h:i A')); ?></span></p>
													</div>
												</li>
											</ul>
										</div>
...
</html>ß<?php /**PATH /home/u881803686/domains/medicalsean.org/public_html/resources/views/doctor/mypatients.blade.php ENDPATH**/ ?>