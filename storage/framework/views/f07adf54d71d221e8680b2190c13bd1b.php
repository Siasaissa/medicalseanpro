...
<body>
                    ...
                    <div class="col-lg-8 col-xl-9">
                        ...
                        <div class="dashboard-header">
                            <div class="d-flex align-items-center gap-3">
                                <h3>Appointments</h3>
                                <a href="<?php echo e(route('patient.doctor-grid')); ?>" class="btn btn-md btn-primary-gradient rounded-pill">
                                    <i class="isax isax-add-square me-1"></i>Book New Appointment
                                </a>
                            </div>
                            <ul class="header-list-btns">
                                <li>
                                    <div class="input-block dash-search-input">
                                        <input type="text" id="appointmentSearch" class="form-control" placeholder="Search by doctor name or ID">
                                ...
                                <ul class="nav nav-pills inner-tab" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="pills-upcoming-tab" data-bs-toggle="pill"
                                            ...
                                            Upcoming<span><?php echo e($counts ?? 0); ?></span>
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-complete-tab" data-bs-toggle="pill"
                                            ...
                                            Completed<span><?php echo e($completed ?? 0); ?></span>
                                        </button>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="position-relative daterange-wraper me-2">
                                    <div class="input-groupicon calender-input">
                                        <input type="text" class="form-control date-range bookingrange"
                                            placeholder="From Date - To Date" id="dateRangePicker">
                                    </div>
                                ...
                                <div id="upcoming-appointments-list">
                                    ...
                                    <?php $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($now->lt($appointmentEnd)): ?>
                                            <?php $hasUpcoming = true; ?>
                                            <div class="appointment-wrap upcoming-appointment-item"
                                                 data-doctor-name="<?php echo e(strtolower($doctor->name ?? '')); ?>"
                                                 data-booking-id="apt000<?php echo e($booking->id); ?>"
                                                 data-appointment-date="<?php echo e($booking->appointment_datetime); ?>">
                                                <ul>
                                                    <li>
                                                        <div class="patinet-information">
                                                            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#appointmentDetailsModal<?php echo e($booking->id); ?>">
                                                                <img src="<?php echo e(asset($booking->doctor->profile->dp ?? 'images/profile-06.jpg')); ?>" onerror="this.src='<?php echo e(asset('images/default.jpeg')); ?>'">
                                                            </a>
                                                            <div class="patient-info">
                                                                <p>#APT000<?php echo e($booking->id); ?></p>
                                                                <h6>
                                                                    <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#appointmentDetailsModal<?php echo e($booking->id); ?>">
                                                                        Dr. <?php echo e($doctor->name ?? 'Unknown Doctor'); ?>
                                                    ...
                                                    <li class="appointment-info">
                                                        <p><i class="isax isax-clock5"></i><?php echo e(Carbon::parse($booking->appointment_datetime)->format('d M Y h:i A')); ?></p>
                                                        <ul class="d-flex apponitment-types">
                                                            <li><?php echo e($booking->service_name ?? 'General Visit'); ?></li>
                                                            <li><span class="badge bg-<?php echo e($booking->appointment_type == 'video' ? 'primary' : ($booking->appointment_type == 'voice' ? 'info' : 'success')); ?>"><?php echo e(ucfirst($booking->appointment_type)); ?></span></li>
                                                        </ul>
                                                    </li>

                                                    <li class="mail-info-patient">
                                                        <ul>
                                                            <li><i class="isax isax-sms5"></i><?php echo e($doctor->email ?? 'No email'); ?></li>
                                                            <li><i class="isax isax-call5"></i><?php echo e($doctor->profile->phone_numbers ?? 'No phone'); ?></li>
                                                        </ul>
                                                    </li>
                                                    ...
                                                    <li class="appointment-action">
                                                        <ul>
                                                            <li>
                                                                <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#appointmentDetailsModal<?php echo e($booking->id); ?>" data-bs-toggle="tooltip" title="View Details">
													...
													<?php if($normalizedStatus == 'PENDING'): ?>
														<li class="appointment-detail-btn">
                                                            <a href="<?php echo e(route('patient.appointment.verify' , $booking->payment_reference)); ?>" class="btn btn-md btn-primary-gradient">
                                                                <i class="isax isax-calendar-tick5 me-1"></i> confirm payment
                                                            </a>
                                                        </li>
														<?php elseif($normalizedStatus == 'PROCESSING'): ?>
														<li class="appointment-detail-btn">
                                                            <a href="<?php echo e(route('patient.appointment.verify' , $booking->payment_reference)); ?>" class="btn btn-md btn-primary-gradient">
                                                                <i class="isax isax-calendar-tick5 me-1"></i> confirm payment
                                                            </a>
                                                        </li>
														<?php elseif($normalizedStatus == 'FAILED' ): ?>
														<li class="appointment-detail-btn">
                                                            <a href="<?php echo e(route('patient.booking', ['doctor' => $doctor->id])); ?>" class="btn btn-md btn-danger-gradient">
                                                                <i class="isax isax-calendar-tick5 me-1"></i> Your Payment Failed
                                                            </a>
                                                        </li>
														<?php endif; ?>
														<?php if($normalizedStatus == 'SUCCESS'): ?>
                                                        <li class="appointment-detail-btn">
                                                            <a href="
                                                                ...
                                                                <?php elseif($booking->appointment_type == 'home'): ?>
                                                                    <?php echo e(route('patient.home', ['booking' => $booking->id])); ?>
                                                    ...
                                                    <?php elseif($now->lt($appointmentStart)): ?>
                                                        <li class="appointment-time-status">
                                                            <span class="badge bg-warning text-dark">
                                                                <i class="isax isax-timer-1 me-1"></i> Starts in <?php echo e($now->diffInHours($appointmentStart)); ?>h
                                                            </span>
                                                        </li>
                                                    <?php endif; ?>
                                                </ul>
                                            ...
                                            <div class="modal fade custom-modal" id="appointmentDetailsModal<?php echo e($booking->id); ?>" tabindex="-1" aria-hidden="true">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="d-flex align-items-center mb-4">
                                                                        <img src="<?php echo e(asset($booking->doctor->profile->dp ?? 'images/profile-06.jpg')); ?>" 
                                                                        ...
                                                                        <div>
                                                                            <h4 class="mb-1">Dr. <?php echo e($doctor->name ?? 'Unknown Doctor'); ?></h4>
                                                                            <p class="text-muted mb-1">Doctor ID: #DOC<?php echo e(str_pad($doctor->id ?? '0', 4, '0', STR_PAD_LEFT)); ?></p>
                                                                            <?php if($now->between($appointmentStart, $appointmentEnd)): ?>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <ul class="info-details">
                                                                        <li>
                                                                            ...
                                                                            <span class="text">#APT000<?php echo e($booking->id); ?></span>
                                                                        </li>
                                                                        <li>
                                                                            <span class="title">Date:</span>
                                                                            <span class="text"><?php echo e(Carbon::parse($booking->appointment_datetime)->format('F d, Y')); ?></span>
                                                                        </li>
                                                                        <li>
                                                                            <span class="title">Time:</span>
                                                                            <span class="text"><?php echo e(Carbon::parse($booking->appointment_datetime)->format('h:i A')); ?></span>
                                                                        </li>
                                                                        <li>
                                                                            <span class="title">Duration:</span>
                                                                            <span class="text"><?php echo e($booking->service_time ?? 30); ?> minutes</span>
                                                                        </li>
                                                                        <li>
                                                                            <span class="title">Service:</span>
                                                                            <span class="text"><?php echo e($booking->service_name ?? 'General Consultation'); ?></span>
                                                                        </li>
                                                                        <li>
                                                                            <span class="title">Type:</span>
                                                                            <span class="text"><span class="badge bg-<?php echo e($booking->appointment_type == 'video' ? 'primary' : ($booking->appointment_type == 'voice' ? 'info' : 'success')); ?>"><?php echo e(strtoupper($booking->appointment_type)); ?></span></span>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <ul class="info-details">
                                                                        <li>
                                                                            ...
                                                                            <span class="text">Dr. <?php echo e($doctor->name ?? 'N/A'); ?></span>
                                                                        </li>
                                                                        <li>
                                                                            <span class="title">Email:</span>
                                                                            <span class="text"><?php echo e($doctor->email ?? 'N/A'); ?></span>
                                                                        </li>
                                                                        <li>
                                                                            <span class="title">Phone:</span>
                                                                            <span class="text"><?php echo e($doctor->profile->phone_numbers ?? 'N/A'); ?></span>
                                                                        </li>
                                                                        <li>
                                                                            <span class="title">Specialization:</span>
                                                                            <span class="text"><?php echo e($doctor->specialization ?? 'General Practitioner'); ?></span>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <?php if($booking->notes): ?>
                                                                <div class="row mt-3">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <p class="text-muted p-3 bg-light rounded"><?php echo e($booking->notes); ?></p>
                                                                    </div>
                                                                </div>
                                                            <?php endif; ?>
                                    ...
                                    <?php if(!$hasUpcoming): ?>
                                        <div class="text-center py-5">
                                            <img src="<?php echo e(asset('images/no-appointments.svg')); ?>" alt="No appointments" style="width: 150px; opacity: 0.5;">
                                            <p class="mt-3 text-muted">No upcoming appointments</p>
                                            <a href="<?php echo e(route('patient.doctor-grid')); ?>" class="btn btn-primary-gradient mt-3">
                                                <i class="isax isax-add-square me-1"></i>Book an Appointment
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                        ...
                                        <?php if(Carbon::parse($booking->appointment_datetime)->lt(Carbon::now())): ?>
                                            ...
                                            <div class="appointment-wrap completed-appointment-item"
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="patinet-information">
                                                            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#completedAppointmentModal<?php echo e($booking->id); ?>">
                                                                <img src="<?php echo e(asset($booking->doctor->profile->dp ?? 'images/profile-06.jpg')); ?>" onerror="this.src='<?php echo e(asset('images/default.jpeg')); ?>'">
                                                            </a>
                                                            <div class="patient-info">
                                                                <p>#APT000<?php echo e($booking->id); ?></p>
                                                    ...
                                                    <li class="appointment-info">
                                                        ...
                                                        <ul class="d-flex apponitment-types">
                                                            <li><?php echo e($booking->service_name ?? 'General Visit'); ?></li>
                                                            <li><span class="badge bg-secondary"><?php echo e(ucfirst($booking->appointment_type)); ?></span></li>
                                                            <li><span class="badge bg-success">Completed</span></li>
                                                        </ul>
                                                    </li>
                                                    <li class="appointment-detail-btn">
                                                        <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#completedAppointmentModal<?php echo e($booking->id); ?>" class="btn btn-outline-primary btn-sm">
                                                            <i class="isax isax-eye4 me-1"></i> View Details
                                                        </a>
                                                        <a href="<?php echo e(route('patient.booking', ['doctor' => $doctor->id])); ?>" class="btn btn-primary-gradient btn-sm ms-2">
                                            ...
                                            <div class="modal fade custom-modal" id="completedAppointmentModal<?php echo e($booking->id); ?>" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Appointment Details</h5>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <ul class="info-details">
                                                                        ...
                                                                        <li>
                                                                            <span class="title">Type:</span>
                                                                            <span class="text"><span class="badge bg-secondary"><?php echo e(strtoupper($booking->appointment_type)); ?></span></span>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="d-flex justify-content-end gap-2">
                                                                        <a href="<?php echo e(route('patient.booking', ['doctor' => $doctor->id])); ?>" class="btn btn-primary">
                                                                            <i class="isax isax-calendar-tick5 me-1"></i> Book Again
                                                                        </a>
    ...
    <style>
        /* Appointment Card Styling - Matches Doctor's Design */
        .appointment-wrap {
            background: white;
            border-radius: 12px;
            padding: 20px;
    ...
    <script>
        ...
        function filterAppointmentsBySearch(className, searchTerm) {
            ...
            items.forEach(item => {
                ...
                if (doctorName.includes(searchTerm) || bookingId.includes(searchTerm)) {
                    item.style.display = '';
                    visibleCount++;
                } else {
                    item.style.display = 'none';
...
<?php /**PATH /Users/dope/Downloads/public_htm/resources/views/patient/appointment.blade.php ENDPATH**/ ?>