            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xl-9">
                        ...
                        <form action="<?php echo e(route('doctor.speciality.update')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                        ...
                        <form action="<?php echo e(route('doctor.availability.update')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <div class="setting-card">
                                <div class="row">
                        ...
                        <form action="<?php echo e(route('doctor.consultation.update')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <div class="setting-card">
                                <div class="row">
                        ...
                        <form action="<?php echo e(route('doctor.payment.update')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <div class="setting-card">
                                <div class="row">
