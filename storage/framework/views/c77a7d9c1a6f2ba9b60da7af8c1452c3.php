                                ...
                                <fieldset id="first" class="step-fieldset">
                                    <div class="card booking-card mb-0">
                                        ...
                                        <div class="card-body booking-body">
                                            ...
                                            <div class="row">
                                                <?php $__empty_1 = true; $__currentLoopData = $serviceOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $serviceOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <?php $inputId = 'service' . $serviceOption['minutes']; ?>
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="service-item">
                                                            <input class="form-check-input ms-0 mt-0" type="radio"
                                                                name="service_time" id="<?php echo e($inputId); ?>"
                                                                value="<?php echo e($serviceOption['minutes']); ?>"
                                                                <?php echo e($index === 0 ? 'checked' : ''); ?>

                                                                data-price="<?php echo e($serviceOption['price']); ?>"
                                                                data-fees="<?php echo e($serviceOption['fees']); ?>"
                                                                data-tax="<?php echo e($serviceOption['tax']); ?>"
                                                                data-discount="<?php echo e($serviceOption['discount']); ?>">
                                                            <label class="form-check-label ms-2" for="<?php echo e($inputId); ?>">
                                                                <span class="service-title d-block mb-1"><?php echo e($serviceOption['label']); ?></span>
                                                                <span class="fs-14 d-block">Tsh <?php echo e($serviceOption['price']); ?></span>
                                                            </label>
                                                        </div>
                                                    </div>
...
<?php /**PATH /Users/dope/Downloads/public_htm/resources/views/patient/booking.blade.php ENDPATH**/ ?>