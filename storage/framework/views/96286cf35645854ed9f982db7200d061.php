        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="card-body">
              ...
              <form method="POST" action="<?php echo e(route('admin.Invoices.store')); ?>" id="invoiceForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="Customer Name *" required>
...
unset($__errorArgs, $__bag); ?>" placeholder="Customer Phone *" required>
...
unset($__errorArgs, $__bag); ?>" rows="2" placeholder="Customer Address *" required></textarea>
...
unset($__errorArgs, $__bag); ?>" placeholder="Customer Email (Optional)">
...
unset($__errorArgs, $__bag); ?>" 
                                 value="<?php echo e(old('invoice_date', date('Y-m-d'))); ?>" placeholder="Invoice Date *" required>
...
unset($__errorArgs, $__bag); ?>" 
                                 value="<?php echo e(old('due_date', date('Y-m-d', strtotime('+30 days')))); ?>" placeholder="Due Date *" required>
...
unset($__errorArgs, $__bag); ?>" 
                                 value="<?php echo e(old('reference')); ?>" placeholder="Reference Number (PO-12345)">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="mb-3">
                          <div class="input-group input-group-outline">
                            <textarea name="note" class="form-control" rows="3" placeholder="Any additional notes..."><?php echo e(old('note')); ?></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
...
</html><?php /**PATH /Users/dope/Downloads/public_htm/resources/views/admin/Invoice/create.blade.php ENDPATH**/ ?>