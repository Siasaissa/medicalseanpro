        ...
        <div class="container">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mb-4"><strong>Doctor Contact:</strong> <?php echo e($booking->doctor->profile?->phone_numbers ?? $booking->doctor->phone ?? 'Not provided'); ?></p>

                    <a href="<?php echo e(route('patient.appointment')); ?>" class="btn btn-primary">Back to Appointments</a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /Users/dope/Downloads/public_htm/resources/views/patient/home.blade.php ENDPATH**/ ?>