<div class="col-lg-4 col-xl-3 theiaStickySidebar">
            ...
            <div class="profile-info-widget">
                <a href="<?php echo e(route('patient.settings')); ?>" class="booking-doc-img">
                    ...
                    <?php if(Auth::user()->profile && Auth::user()->profile->dp): ?>
                        <img src="<?php echo e(asset(Auth::user()->profile->dp)); ?>" alt="Profile Photo"
                            class="img-fluid rounded-circle">
                    <?php else: ?>
                        <img src="<?php echo e(asset('images/profile-06.jpg')); ?>" alt="Default Avatar"
                            class="img-fluid rounded-circle">
                    <?php endif; ?>
                </a>
    ...
    <!-- /Profile Sidebar -->
</div><?php /**PATH /Users/dope/Documents/sean/sean/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>