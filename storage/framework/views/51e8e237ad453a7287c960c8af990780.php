										...
										<div class="appointment-wrap appointment-grid-wrap">
											<ul>
													...
													<div class="appointment-grid-head">
														<div class="patinet-information">
															<a href="patient-profile.html">
																<img src="<?php echo e(asset($patientProfile?->dp ?? 'images/profile-06.jpg')); ?>" alt="User Image">
															</a>


															<div class="patient-info">
																<p>#Apt000<?php echo e($patientUser?->id ?? 'N/A'); ?></p>
																<h6><a
																		href="#"><?php echo e($patientUser?->name ?? 'Unknown Patient'); ?></a>
																</h6>
																<ul>
																	<?php
																	...
																	<li>Sex: <?php echo e($patientProfile?->sex ?? 'Not set'); ?>

																	</li>
																	<li>Blood Group: <?php echo e($patientProfile?->blood_group ?? 'Not set'); ?>
												...
												<li class="appointment-info">
													<p><i class="isax isax-clock5"></i>Join : <?php echo e($patientUser?->created_at ?? 'N/A'); ?></p>
													<p class="mb-0"><i class="isax isax-location5"></i><?php echo e($patientProfile?->address ?? 'Address not set'); ?></p>
												</li>
												<li class="appointment-action">
													<div class="patient-book">
														<p><i class="isax isax-calendar-1"></i>Last Booking
															<span>
																<?php echo e($patient->last_appointment ? \Carbon\Carbon::parse($patient->last_appointment)->format('M d, Y h:i A') : 'No booking yet'); ?>
...
<?php /**PATH /Users/dope/Downloads/public_htm/resources/views/doctor/mypatients.blade.php ENDPATH**/ ?>