                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-wrap">
                                            ...
                                            <input type="text" name="blood_group" class="form-control"
                                                value="{{ old('blood_group', $doctor->blood_group) }}"
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-wrap">
                                            ...
                                            <input type="text" name="marital_status" class="form-control"
                                                value="{{ old('marital_status', $doctor->marital_status) }}"
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-wrap">
                                            ...
                                            <input type="text" name="phone_numbers" class="form-control"
                                                value="{{ old('phone_numbers', $doctor->phone_numbers) }}"
                                        ...
                                        <div class="form-wrap">
                                            ...
                                            <div class="input-block input-block-new mb-0">
                                                <input class="input-tags form-control" id="inputBox3" type="text"
                                                    ...
                                                    value="{{ old('known_languages', $doctor->known_languages) }}"
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="form-wrap">
                                                ...
                                                <input type="number" name="year_of_experience" class="form-control"
                                                    value="{{ old('year_of_experience', $doctor->year_of_experience) }}"
                                                    placeholder="e.g., 10">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-9">
                                            <div class="form-wrap">
                                                ...
                                                <textarea name="job_description" class="form-control"
                                                    placeholder="Briefly describe your role and duties">{{ old('job_description', $doctor->job_description) }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="form-wrap">
                                                ...
                                                <input type="date" name="start_date" class="form-control"
                                                    value="{{ old('start_date', $doctor->start_date) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="form-wrap">
                                                ...
                                                <input type="date" name="end_date" class="form-control"
                                                    value="{{ old('end_date', $doctor->end_date) }}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="form-wrap w-100">
                                                    ...
                                                    <input type="text" name="about_membership" class="form-control"
                                                        value="{{ old('about_membership', $doctor->about_membership) }}"
