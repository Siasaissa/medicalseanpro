                                                    ...
                                                    <li>
                                                        <div class="patinet-information">
                                                            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#appointmentDetailsModal{{ $booking->id }}">
                                                                <img src="{{ asset($booking->doctor->profile->dp ?? 'images/profile-06.jpg') }}" alt="{{ $patient->name ?? 'Patient' }}" onerror="this.src='{{ asset('images/default.jpeg') }}'">
                                                            </a>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="d-flex align-items-center mb-4">
                                                                        <img src="{{ asset($booking->patient->profile->dp ?? 'images/profile-06.jpg') }}" 
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="d-flex align-items-center mb-4">
                                                                        <img src="{{ asset($booking->patinet->profile->dp ?? 'images/profile-06.jpg') }}" 
