...
@endif
    ...
    <div class="form-set-button">
		...
		<!-- jQuery -->
		<script src="{{asset('js/jquery-3.7.1.min.js')}}" type="71c8024a7b85cbfe95ba97a6-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
		<script src="{{asset('js/bootstrap.bundle.min.js')}}" type="71c8024a7b85cbfe95ba97a6-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="{{asset('js/select2.min.js')}}" type="71c8024a7b85cbfe95ba97a6-text/javascript"></script>
		
		<!-- Sticky Sidebar JS -->
        <script src="{{asset('js/ResizeSensor.js')}}" type="71c8024a7b85cbfe95ba97a6-text/javascript"></script>
        <script src="{{asset('js/theia-sticky-sidebar.js')}}" type="71c8024a7b85cbfe95ba97a6-text/javascript"></script>
		
		<!-- Custom JS -->
		<script src="{{asset('js/script.js')}}" type="71c8024a7b85cbfe95ba97a6-text/javascript"></script>
		
	<script src="{{asset('js/rocket-loader.min.js')}}" data-cf-settings="71c8024a7b85cbfe95ba97a6-|49" defer=""></script><script defer="" src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" data-cf-beacon="{" version":"2024.11.0","token":"3ca157e612a14eccbb30cf6db6691c29","server_timing":{"name":{"cfcachestatus":true,"cfedge":true,"cfextpri":true,"cfl4":true,"cforigin":true,"cfspeedbrain":true},"location_startswith":null}}"="" crossorigin="anonymous"></script>
