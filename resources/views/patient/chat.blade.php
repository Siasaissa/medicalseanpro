                        ...
                        <div class="chat chat-messages" id="chatMessages">
                                    ...
                                    <div class="chat-header">
                                        <div class="user-details">
                                            ...
                                            <figure class="avatar avatar-online">
                                                <img src="{{ $currentPatientImage }}" alt="{{ $currentPatient?->name ?? 'Patient' }}">
                                            </figure>
                                            <div class="mt-1">
                                                <h5>{{ $currentPatient?->name ?? 'Select a chat' }}</h5>
                            ...
                            <div class="chat-footer">
                                <form action="{{ route('chat.store') }}" method="POST" id="chatForm">
                                    ...
                                    @endphp
                                    <input type="hidden" name="receiver_id" value="{{ $currentPatientId }}">
