            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        ...
                        <!-- Form starts here -->
                        <form action="{{ route('patient.booking.store', $doctor->id) }}" method="POST" id="booking-form">
                            @csrf
                            ...
                            <input type="hidden" id="phone-hidden" name="phone" value="{{ Auth::user()->phone ?? '' }}">
                                    ...
                                    <div class="card booking-card mb-0">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="d-flex align-items-center flex-wrap">
                                                            <span class="avatar avatar-xxxl avatar-rounded me-2">
                                                                <img src="{{ asset($doctor->profile->dp) }}" alt="User Image">
                                                            </span>
                                                            <div>
                                                                ...
                                                                <p class="text-indigo mb-3 fw-medium">{{ $doctor->profile->speciality ?? 'No speciality' }}</p>
                                                                <p class="mb-0">
                                                                    <i class="isax isax-location me-2"></i>{{ $doctor->profile->address ?? 'No Address' }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card-footer">
                                            <div class="d-flex justify-content-between">
                                                <a href="{{ url()->previous() }}" class="btn btn-md btn-dark rounded-pill">
                                    ...
                                    <div class="card booking-card">
                                        <div class="card-body text-center">
                                            <div class="mb-4">
                                                ...
                                                <p class="lead">Your appointment with Dr. {{ $doctor->name }} is being processed.</p>
                                            ...
                                            <div class="actions mt-4">
                                                <a href="{{ route('patient.appointment') }}" class="btn btn-primary btn-lg">
