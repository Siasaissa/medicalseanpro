                    ...
                    <div class="col-lg-8 col-xl-9">
                        <div class="dashboard-header">
                            <div class="d-flex align-items-center gap-3">
                                <h3>Appointments</h3>
                                <a href="{{ route('patient.doctor-grid') }}" class="btn btn-md btn-primary-gradient rounded-pill">
                                ...
                                <ul class="nav nav-pills inner-tab" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-complete-tab" data-bs-toggle="pill"
                                            ...
                                            Completed<span>{{ $completed ?? 0 }}</span>
                                        </button>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div id="upcoming-appointments-list">
                                    ...
                                    @foreach ($bookings as $booking)
                                        ...
                                        @if ($now->lt($appointmentEnd))
                                            ...
                                            <div class="appointment-wrap upcoming-appointment-item"
                                                 data-doctor-name="{{ strtolower($doctor->name ?? '') }}"
                                                    ...
                                                    <li>
                                                        <div class="patinet-information">
                                                            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#appointmentDetailsModal{{ $booking->id }}">
                                                                <img src="{{ $doctorImage }}" alt="{{ $doctor->name ?? 'Doctor' }}" onerror="this.src='{{ asset('images/default.jpeg') }}'">
                                                            </a>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="d-flex align-items-center mb-4">
                                                                        ...
                                                                        <div>
                                                                            <h4 class="mb-1">Dr. {{ $doctor->name ?? 'Unknown Doctor' }}</h4>
                                                                            <p class="text-muted mb-1">Doctor ID: #DOC{{ str_pad($doctor->id ?? '0', 4, '0', STR_PAD_LEFT) }}</p>
                                                                            @if ($now->between($appointmentStart, $appointmentEnd))
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <ul class="info-details">
                                                                        <li>
                                                                            ...
                                                                            <span class="text">Dr. {{ $doctor->name ?? 'N/A' }}</span>
                                                                        </li>
                                                                        <li>
                                                                            <span class="title">Email:</span>
                                                                            <span class="text">{{ $doctor->email ?? 'N/A' }}</span>
                                                                        </li>
                                                                        <li>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <span class="text">{{ $doctor->specialization ?? 'General Practitioner' }}</span>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                    ...
                                    @if(!$hasUpcoming)
                                        <div class="text-center py-5">
                                            ...
                                            <a href="{{ route('patient.doctor-grid') }}" class="btn btn-primary-gradient mt-3">
