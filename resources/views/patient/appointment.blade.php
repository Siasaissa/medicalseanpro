...
<body>
    ...
    <span class="add-icon" style="margin-left: 0.2%;">
        <i class="fa-solid fa-circle-plus fs-10"></i>
    </span>
    </a>
</div>
						...
						@if (Carbon\Carbon::now()->lt($appointmentEnd))
							<div class="appointment-wrap">
								<ul>
									<li>
										<div class="patinet-information">
											...
											<div class="patient-info">
												...
												<h6><a href="#">{{ $booking->doctor->name }}</a></h6>
											</div>
										</div>
									</li>
									...
									@if (Carbon\Carbon::now()->between($appointmentStart, $appointmentEnd))
									...
									@else
										<span class="text-danger">
											@if (Carbon\Carbon::now()->lt($appointmentStart))
						...
						@endif
							...
							<div class="tab-pane fade" id="pills-complete" role="tabpanel"
								...
								<div id="completed-bookings-container">
									@foreach ($bookings as $booking)
										@if (Carbon\Carbon::parse($booking->appointment_datetime)->lt(Carbon\Carbon::now()))
											<div class="appointment-wrap">
												<ul>
													<li>
														<div class="patinet-information">
															<a href="patient-completed-appointment.html">
																<img src="{{ asset($booking->doctor->profile->dp) ?? asset('images/profile-06.jp') }}"
																	alt="User Image">
															</a>
															<div class="patient-info">
																<p>#Apt000{{ $booking->id }}</p>
																<h6><a
																		href="patient-completed-appointment.html">{{ $booking->doctor->name }}</a>
																</h6>
															</div>
														</div>
													</li>
													<li class="appointment-info">
														<p><i class="isax isax-clock5"></i>{{ $booking->appointment_datetime }}
														</p>
														<ul class="d-flex apponitment-types">
															<li>General Visit</li>
															<li>Video Call</li>
