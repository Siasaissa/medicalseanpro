                    ...
                    <div class="header-menu">
                        <div class="main-menu-wrapper">
                            ...
                            <ul class="main-nav">
                                ...
                                <li class="menu"><a href="{{ route('about.us') }}">About Us</a></li>
                                <li class="menu active"><a href="{{ route('blog.grid') }}">Blog Grid</a></li>
                        ...
                        <div class="col-md-6 col-lg-4 d-flex mb-4">
                            <div class="card border-0 shadow-sm w-100 h-100">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <p class="text-muted mb-2"><i class="feather-calendar me-1"></i>{{ $post['date'] }}</p>
                                    <h5 class="mb-2">{{ $post['title'] }}</h5>
                                    <p class="mb-4">{{ $post['excerpt'] }}</p>
                                    <div class="mt-auto">
                                        <a href="{{ route('about.us') }}" class="btn btn-sm btn-outline-primary me-2">Learn More</a>
                                        <a href="{{ route('register') }}" class="btn btn-sm btn-primary-gradient">Book Doctor</a>
                                    </div>
                                </div>
                            </div>
                        </div>
