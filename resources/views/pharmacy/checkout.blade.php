...
$(document).ready(function () {
	...
	<!-- jQuery -->
	<script src="{{asset('js/jquery-3.7.1.min.js')}}" type="fd3b17be20ca06d8e1a6b747-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="{{asset('js/bootstrap.bundle.min.js')}}" type="fd3b17be20ca06d8e1a6b747-text/javascript"></script>

	<!-- Sticky Sidebar JS -->
	<script src="{{asset('js/ResizeSensor.js')}}" type="fd3b17be20ca06d8e1a6b747-text/javascript"></script>
	<script src="{{asset('js/theia-sticky-sidebar.js')}}" type="fd3b17be20ca06d8e1a6b747-text/javascript"></script>

	<!-- Custom JS -->
	<script src="{{asset('js/script.js')}}" type="fd3b17be20ca06d8e1a6b747-text/javascript"></script>

	<script src="{{asset('js/rocket-loader.min.js')}}" data-cf-settings="fd3b17be20ca06d8e1a6b747-|49"
		defer=""></script>
	<script defer=""
