<footer class="footer inner-footer">
				<div class="footer-top">
					...
					<div class="footer-bg">
						<img src="{{asset('images/footer-bg-01.png')}}" alt="img" class="footer-bg-01">
						<img src="{{asset('images/footer-bg-02.png')}}" alt="img" class="footer-bg-02">
						<img src="{{asset('images/footer-bg-03.png')}}" alt="img" class="footer-bg-03">
						<img src="{{asset('images/footer-bg-04.png')}}" alt="img" class="footer-bg-04">
						<img src="{{asset('images/footer-bg-05.png')}}" alt="img" class="footer-bg-05">
					</div>
				</div>
					...
					<div class="container">
						...
						<div class="copyright">
							...
							<ul class="payment-method">
								<li><a href="javascript:void(0);"><img src="{{asset('images/card-01.svg')}}" alt="Img"></a></li>
								<li><a href="javascript:void(0);"><img src="{{asset('images/card-02.svg')}}" alt="Img"></a></li>
								<li><a href="javascript:void(0);"><img src="{{asset('images/card-03.svg')}}" alt="Img"></a></li>
								<li><a href="javascript:void(0);"><img src="{{asset('images/card-04.svg')}}" alt="Img"></a></li>
								<li><a href="javascript:void(0);"><img src="{{asset('images/card-05.svg')}}" alt="Img"></a></li>
								<li><a href="javascript:void(0);"><img src="{{asset('images/card-06.svg')}}" alt="Img"></a></li>
							</ul>
						</div>
						<!-- /Copyright -->					
					</div>
